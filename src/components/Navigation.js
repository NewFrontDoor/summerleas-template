...
class Navigation extends Component {
  render() {
    return (
        ...
        <div className="container">
          <div className="row">
            ...
            <div id="logo-region" className="logo col-xs-12 col-md-3 text-center-sm">
                        <a href="/"><img src="https://summerleaschurch.org/sites/summerleaschurch.org/files/summerleas_web_logo.png" alt="Home" className="logo" /></a>
                      </div> {/* /logo-region */}
      ...
      <div className="content">
        <h3>Welcome to Summerleas Christian Church...</h3>  </div>
      </div>  </div>
      </div>
      </div>
      </div>
      ...
      <li className="tb-megamenu-item level-2 mega">
      <a href="#"  title="Listen">Listen</a>
      </li>

      <li className="tb-megamenu-item level-2 mega">
      <a href="/"  title="Sermons Page">Sermons Page</a>
      </li>

      <li className="tb-megamenu-item level-2 mega">
      <a href="/"  title="Search our talks">Search our talks</a>
      </li>
      </ul>
      </div>
      </div>
      ...
      <li className="tb-megamenu-item level-2 mega">
      <a href="#"  title="Discipleship">Discipleship</a>
      </li>

      <li className="tb-megamenu-item level-2 mega">
      <a href="/" >Gospel Centered Life</a>
      </li>

      <li className="tb-megamenu-item level-2 mega">
      <a href="/" >GC Foundations</a>
      </li>

      <li className="tb-megamenu-item level-2 mega">
      <a href="/" >Gospel Fluency</a>
      </li>
      ...
      <li className="tb-megamenu-item level-2 mega">
      <a href="/"  title="What We Believe">What We Believe</a>
      </li>
      </ul>
      </div>
      </div>
